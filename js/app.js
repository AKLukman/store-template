...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h3 class="text-color">${product.title}</h3>
      <p class="text-color">Category: ${product.category}</p>
      <h5 class="text-color1">Rating: ${product.rating.rate}(${product.rating.count})</h5>
      <h2 class="text-color">Price: $ ${product.price}</h2>
